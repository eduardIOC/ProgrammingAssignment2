## makeCacheMatrix: It's a function that creates a special "matrix" object that can
##                  cache its inverse.
## cacheSolve: It's a function that computes the inverse of the special "matrix" 
...
## function makeCacheMatrix. However, it first checks to see if the inverse 
